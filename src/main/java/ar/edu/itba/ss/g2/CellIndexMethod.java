...
public class CellIndexMethod {
    ...
    public static Map<Particle, Set<Particle>> calculate(List<Particle> particles, Long L, Long M, Double rc, boolean isToroidal) {
        List<List<Set<Particle>>> grid = isToroidal ? generateToroidalGrid(particles, L, M) : generateGrid(particles, L, M);
    ...
    private static void checkAdjacent(List<List<Set<Particle>>> grid, int x, int y, double rc, Particle p, Map<Particle, Set<Particle>> map, boolean isToroidal, long L) {
    ...
    private static List<List<Set<Particle>>> generateGrid(List<Particle> particles, long L, long M) {
    ...
    private static List<List<Set<Particle>>> generateToroidalGrid(List<Particle> particles, long L, long M) {
    ...
    private static void addIfClose(Particle p1, Particle p2, Double rc, Map<Particle, Set<Particle>> map, boolean isToroidal, long L) {
